    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      if (e.deltaY > 0) {
        ...
        if (currentScroll < sectionEnd - 20) {
          // Still content left in current section: scroll within the section
          e.preventDefault();
        ...
        if (currentScroll > sectionStart + 20) {
          // Still content before start of current section: scroll back within section
          e.preventDefault();
    ...
    <>
      ...
      <div className="hidden lg:block">
        ...
        <div
          ...
          <div
            id="more"
            className="w-screen h-full bg-black flex-none overflow-y-auto scrollbar-hide flex items-center justify-center">
            {moreSection}
          </div>
          {footerSection && (
            <div
